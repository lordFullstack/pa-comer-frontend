...
/**
 * CORS
 * Allows the production Vercel frontend and local development.
 * This is implemented without adding a new dependency so the existing
 * backend package remains unchanged.
 */
const allowedOrigins = new Set([
  "https://pa-comer-frontend-yxs9.vercel.app",
  "http://localhost:5173",
  "http://127.0.0.1:5173",
]);
